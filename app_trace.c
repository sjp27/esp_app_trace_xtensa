...
/* Modified for Arduino compatibiity */
...
esp_err_t esp_apptrace_init(void)
{
    ...
    if (cpu_hal_get_core_id() == CONFIG_ARDUINO_RUNNING_CORE) { // Modified for Arduino compatibiity
        ...
        // Modified for Arduino compatibiity - removed uart trace channels 
        s_inited = true;
    }
